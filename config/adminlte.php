    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                ['text' => 'Products', 'route' => 'admin.products.index'],
                ['text' => 'Product Report', 'route' => 'admin.products.report'],
                [
                    'text' => 'Stock',
                    'submenu' => [
                        ['text' => 'Stores', 'route' => 'admin.stores.index'],
                        ['text' => 'Stock List', 'route' => 'admin.stocks.index'],
                        ['text' => 'Low Quantity', 'route' => 'admin.stocks.low-quantity'],
                        ['text' => 'Expiring (1 Month)', 'route' => 'admin.stocks.expiry.one-month'],
                        ['text' => 'Expiring (3 Months)', 'route' => 'admin.stocks.expiry.three-month'],
                    ],
                ],
            ],
        ],
        [
            ...
            'submenu' => [
                ...
                ['text' => 'New Purchase', 'route' => 'admin.purchases.create'],
                ['text' => 'Purchase Report', 'route' => 'admin.purchases.report'],
            ],
        ],
        [
            'text' => 'Sales',
            ...
            'submenu' => [
                ...
                ['text' => 'Sale Report', 'route' => 'admin.sales.report'],
            ],
        ],
        [
            'text' => 'Orders',
        ...
        [
            ...
            'submenu' => [
                ...
                ['text' => 'Client Feedback', 'route' => 'admin.feedbacks.index'],
            ],
        ],
        [
            'text' => 'Expenses',
            ...
            'submenu' => [
                ...
                ['text' => 'Expense Report', 'route' => 'admin.expenses.report'],
            ],
        ],
        [
            'text' => 'Cash & Bank',
            ...
            'submenu' => [
                ...
                ['text' => 'Transfer', 'route' => 'admin.cash-bank.transfer.form'],
                ['text' => 'Transfer History', 'route' => 'admin.cash-bank.transfer-history'],
                ['text' => 'Accounts Payable', 'route' => 'admin.accounts.payable'],
                ['text' => 'Accounts Receivable', 'route' => 'admin.accounts.receivable'],
                ['text' => 'Salaries', 'route' => 'admin.salaries.index'],
            ],
        ],
        [
            'text' => 'Assets',
        ...
        [
            ...
            'submenu' => [
                ...
                ['text' => 'Purchase Report', 'route' => 'admin.purchases.report'],
                ['text' => 'Expense Report', 'route' => 'admin.expenses.report'],
                ['text' => 'Profit Report', 'route' => 'admin.reports.profit'],
                ['text' => 'Stock Report', 'route' => 'admin.reports.stock'],
