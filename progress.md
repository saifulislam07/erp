...
**সারসংক্ষেপ: ১৩/১৩ ফেজ শেষ ✅ · note.text-এর ১৬/১৬ আইটেম শেষ ✅ · টেস্ট স্যুট ১৪০/১৪০ সবুজ ✅ · বাকি আছে শুধু সার্ভার-সাইড ডিপ্লয়মেন্ট**
...
**ফলাফল: ১৪০টি টেস্ট, ৩৫৩টি অ্যাসারশন, সব পাস।**
...
### ক্লায়েন্ট রিটার্ন — transaction ফিক্স ✅

- [x] `Client/ReturnController::store` এখন `DB::transaction`-এ মোড়া। আগে হেডার রো আইটেম লুপের আগেই কমিট হয়ে যেত, তাই টেম্পার করা পেলোডে অন্য অর্ডারের `order_item_id` দিলে `findOrFail` 404 করত ঠিকই — কিন্তু অ্যাডমিনের কিউতে একটা খালি pending রিটার্ন থেকে যেত
- [x] `ClientReturnFlowTest` — ৬টি টেস্ট (ownership, delivered-only, পরিমাণের সীমা, একাধিক রিকোয়েস্টে জমা হওয়া, অনাথ রো না থাকা)
- ফিক্স সাময়িকভাবে সরিয়ে যাচাই করা হয়েছে যে রিগ্রেশন টেস্টটা আসলেই বাগটা ধরে
