...
@section('content_title', 'Create Sale')
        ...
        <form action="{{ route('admin.sales.store') }}" method="post" id="sale-form">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input type="radio" name="customer_type" value="local" id="type_local" class="form-check-input" checked>
                            <label class="form-check-label" for="type_local">Local</label>
                        </div>
                        @if ($canSellToClientAgent)
                            <div class="form-check form-check-inline">
                                <input type="radio" name="customer_type" value="client_agent" id="type_client" class="form-check-input">
                ...
                <div class="form-group" id="client-customer-field" style="display:none; position: relative;">
                    ...
                    <input type="text" id="customer_search" class="form-control @error('customer_id') is-invalid @enderror" placeholder="Search by name or ID...">
        ...
        $(function () {
            ...
            function addRow() {
                ...
                const discountCell = canApplyDiscount
                    ? `<td><input type="number" step="0.01" name="items[${index}][discount_amount]" class="form-control discount" value="0"></td>`
                    : '';
                ...
                const row = $(`
                    <tr data-index="${index}">
                        ...
                        <td><input type="number" step="0.01" name="items[${index}][quantity]" class="form-control quantity" value="1"></td>
                        <td><input type="number" step="0.01" name="items[${index}][unit_price]" class="form-control price" value="0"></td>
                        ${discountCell}
                        <td><input type="number" step="0.01" name="items[${index}][vat_percentage]" class="form-control vat" value="0"></td>
